...
//Our main ball .This is now the bat
...
//Hoop, only serves as decoration. This is now the projectile
class Hoop extends Entity {
    ...
    //check collision with a hoop side : with bat
    /*checkCollision(other) {
        let distX = abs(this.pos.x - other.pos.x);
        let distY = abs(this.pos.y - other.pos.y);
        let distCheck = this.radius;
